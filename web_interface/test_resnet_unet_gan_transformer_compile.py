#!/usr/bin/env python3
"""
Test that the 4 new model graphs (resnet, unet, gan, vanilla_transformer)
...
MODEL_GRAPHS = {
    "resnet":              os.path.join(SCRIPT_DIR, "models", "resnet.json"),
    "unet":                os.path.join(SCRIPT_DIR, "models", "unet.json"),
    "gan":                 os.path.join(SCRIPT_DIR, "models", "gan.json"),
    "vanilla_transformer": os.path.join(SCRIPT_DIR, "models", "vanilla_transformer.json"),
}
...
COMPONENT_PATHS = {
    ...
    "molecular/conv2d_transpose":   os.path.join(SCRIPT_DIR, "components", "conv2d_transpose.json"),
    ...
    "molecular/batchnorm":          os.path.join(SCRIPT_DIR, "components", "batchnorm.json"),
...
def main():
    ...
    print(f"{'=' * 60}")
    if all_pass:
        print("  All 4 models compiled and executed successfully!")
    else:
