#!/usr/bin/env python3
"""
Test that the 3 new model graphs (llada, mamba, qwen) compile to valid,
runnable Python code via the Rapid Neural Designer's handlebars-style
template compiler.

Reuses the same compiler logic as test_models_compile.py.
"""
...
MODEL_GRAPHS = {
    "llada": os.path.join(SCRIPT_DIR, "models", "llada.json"),
    "mamba": os.path.join(SCRIPT_DIR, "models", "mamba.json"),
    "qwen":  os.path.join(SCRIPT_DIR, "models", "qwen.json"),
}
...
COMPONENT_PATHS = {
    ...
    "molecular/llada_block":      os.path.join(SCRIPT_DIR, "components", "llada_block.json"),
    "molecular/mamba_block":      os.path.join(SCRIPT_DIR, "components", "mamba_block.json"),
    "molecular/qwen_block":       os.path.join(SCRIPT_DIR, "components", "qwen_block.json"),
...
# ---------------------------------------------------------------
# Compiler (identical logic to test_models_compile.py)
# ---------------------------------------------------------------
...
def compile_graph(graph, comp_defs, atomic_defs):
    ...
    for nid in ordered_ids:
        ...
        # Use "id" if present, otherwise use lowercased "name"
...
def main():
    ...
    print(f"{'=' * 60}")
    if all_pass:
        print("  All 3 models compiled and executed successfully!")
    else:
