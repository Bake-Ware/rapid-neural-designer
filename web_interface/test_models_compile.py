#!/usr/bin/env python3
"""
Test that the 4 model graphs (mlp, cnn, rnn, gat) compile to valid,
runnable Python code via the Rapid Neural Designer's handlebars-style
template compiler.

Reuses the same compiler logic as test_llama_compile.py.
"""
...
MODEL_GRAPHS = {
    "mlp": os.path.join(SCRIPT_DIR, "models", "mlp.json"),
    "cnn": os.path.join(SCRIPT_DIR, "models", "cnn.json"),
    "rnn": os.path.join(SCRIPT_DIR, "models", "rnn.json"),
    "gat": os.path.join(SCRIPT_DIR, "models", "gat.json"),
}
...
# ---------------------------------------------------------------
# Compiler (identical logic to test_llama_compile.py)
# ---------------------------------------------------------------
